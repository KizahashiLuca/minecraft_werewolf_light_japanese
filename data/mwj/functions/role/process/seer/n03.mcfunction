...
execute if score @p[scores={NUM=3}] ROLE matches 3 run tellraw @s ["",{"selector":"@p[scores={NUM=3}]","color":"reset"},{"text":" は ","color":"reset"},{"text":"狐","color":"dark_purple","bold":true},{"text":" です","color":"reset"}]
execute if score @p[scores={NUM=3}] ROLE matches 3 as @p[scores={NUM=3}] run function mwj:role/process/seer/forfox
