...
execute unless score @p[scores={NUM=3}] ROLE matches 1 run tellraw @s ["",{"selector":"@p[scores={NUM=3}]","color":"reset"},{"text":" は ","color":"reset"},{"text":"白","color":"green","bold":true},{"text":" です","color":"reset"}]
