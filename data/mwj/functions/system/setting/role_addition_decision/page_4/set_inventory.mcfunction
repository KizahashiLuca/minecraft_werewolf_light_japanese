...
## Set scoreboard
scoreboard players operation #MWL AddedDetec = #MWL AddedRole1
scoreboard players operation #MWL AddedThief = #MWL AddedRole2
scoreboard players operation #MWL AddedLtRed = #MWL AddedRole3
scoreboard players operation #MWL AddedCat = #MWL AddedRole4
