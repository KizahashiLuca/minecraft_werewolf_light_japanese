...
## Set scoreboard
scoreboard players operation #MWL AddedThief = #MWL AddedRole1
scoreboard players operation #MWL AddedLtRed = #MWL AddedRole2
scoreboard players operation #MWL AddedCat = #MWL AddedRole3
