...
execute if score #MWL AddedLycant matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"狼 憑 き","color":"green","bold":true},{"text":" : ","color":"white"},{"score":{"name":"#MWL","objective":"AddedLycant"},"color":"white"},{"text":"人","color":"white"}]
...
# execute if score #MWL Added matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"追加役職","color":"white","bold":true},{"text":" : ","color":"white"},{"score":{"name":"#MWL","objective":"Added"},"color":"white"},{"text":"人","color":"white"}]
execute if score #MWL AddedWolf matches ..0 if score #MWL AddedClWolf matches ..0 if score #MWL AddedWhWolf matches ..0 if score #MWL AddedMadman matches ..0 if score #MWL AddedFanatic matches ..0 if score #MWL AddedFox matches ..0 if score #MWL AddedImmoral matches ..0 if score #MWL AddedVilla matches ..0 if score #MWL AddedBakery matches ..0 if score #MWL AddedLycant matches ..0 if score #MWL AddedMason matches ..0 if score #MWL AddedSeer matches ..0 if score #MWL AddedFkSeer matches ..0 if score #MWL AddedSage matches ..0 if score #MWL AddedMedium matches ..0 if score #MWL AddedDetec matches ..0 if score #MWL AddedThief matches ..0 if score #MWL AddedLtRed matches ..0 if score #MWL AddedCat matches ..0 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"なし","color":"white","bold":true}]
...
function mwj:system/setting/role_addition_decision/page_1/set_added
