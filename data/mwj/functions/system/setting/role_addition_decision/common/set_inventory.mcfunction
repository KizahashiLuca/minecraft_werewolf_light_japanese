...
execute if score #MWL Phase matches 90 run function mwj:system/setting/role_addition_decision/page_1/set_inventory
execute if score #MWL Phase matches 91 run function mwj:system/setting/role_addition_decision/page_2/set_inventory
execute if score #MWL Phase matches 92 run function mwj:system/setting/role_addition_decision/page_3/set_inventory
execute if score #MWL Phase matches 93 run function mwj:system/setting/role_addition_decision/page_4/set_inventory
...
function mwj:system/setting/role_addition_decision/common/added_rest_number
scoreboard players operation #MWL AddedRoleTmp = #MWL AddedRole1
function mwj:system/setting/role_addition_decision/common/selected_role1
scoreboard players operation #MWL AddedRoleTmp = #MWL AddedRole2
function mwj:system/setting/role_addition_decision/common/selected_role2
scoreboard players operation #MWL AddedRoleTmp = #MWL AddedRole3
function mwj:system/setting/role_addition_decision/common/selected_role3
scoreboard players operation #MWL AddedRoleTmp = #MWL AddedRole4
function mwj:system/setting/role_addition_decision/common/selected_role4
scoreboard players operation #MWL AddedRoleTmp = #MWL AddedRole5
function mwj:system/setting/role_addition_decision/common/selected_role5
