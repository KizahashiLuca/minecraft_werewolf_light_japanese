...
replaceitem entity @p[tag=Host] inventory.13 minecraft:lingering_potion{display:{Name:"\"\\u00A7r即死の残留ポーション\""},CustomPotionEffects:[{Id:7,Amplifier:3}],CustomPotionColor:16122102} 1
