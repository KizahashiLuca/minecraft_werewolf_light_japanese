...
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:lingering_potion",tag:{display:{Name:"\"\\u00A7r\\u00A7f即死の残留ポーション\""},CustomPotionEffects:[{Id:7,Amplifier:3}],CustomPotionColor:16122102}}}] ThrowItem 1
