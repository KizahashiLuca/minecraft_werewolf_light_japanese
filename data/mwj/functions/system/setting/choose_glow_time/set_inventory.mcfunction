...
loot replace entity @p[tag=Host] inventory.4 loot mwj:setting/choose_mode/choose_glow_time
...
loot replace entity @p[tag=Host] inventory.15 loot mwj:setting/common/character/percent
