...
## Replace Inventory
replaceitem entity @p[tag=host] inventory.12 minecraft:flower_banner_pattern{display:{Name:"\"\\u00A7r通常人狼モード\""}} 1
replaceitem entity @p[tag=host] inventory.13 minecraft:flower_banner_pattern{display:{Name:"\"\\u00A7r村人2人生存モード\""}} 1
replaceitem entity @p[tag=host] inventory.14 minecraft:flower_banner_pattern{display:{Name:"\"\\u00A7r我々だ！人狼モード\""}} 1
