...
scoreboard players set @p[tag=Host] SelectedConduit 1
...
execute if score Time AddedConduit matches 1 run scoreboard players set @p[tag=Host] SelectedDecide2 1
...
execute if score Time AddedConduit matches 1 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:12b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r選択済み\""}}}]}] SelectedDecide2 0
...
execute if score @p[tag=Host] SelectedConduit matches 1 run function mwj:system/setting/decision_item_addition3/selected_conduit
