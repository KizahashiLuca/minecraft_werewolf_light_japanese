...
execute if score Time Version matches ..14 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:23b,id:"minecraft:air",tag:{}}]}] SelectItem4 0
execute if score Time Version matches 15.. run function mwj:system/setting/decision_item_addition3/detect_haven_honey_block
execute if score Time Version matches ..15 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:24b,id:"minecraft:air",tag:{}}]}] SelectItem5 0
execute if score Time Version matches 16.. run function mwj:system/setting/decision_item_addition3/detect_haven_soul_lantern
