...
execute if score #MWL Version matches ..14 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:23b,id:"minecraft:air"}]}] SelectItem4 0
execute if score #MWL Version matches 15.. run function mwj:system/setting/decision_item_addition3/detect_haven_honey_block
execute if score #MWL Version matches ..15 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:24b,id:"minecraft:air"}]}] SelectItem5 0
