...
## Declare Inventory
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:20b,id:"minecraft:trident",tag:{display:{Lore:['"\\u00A7r\\u00A77召雷"','"\\u00a7r\\u00A7f使用方法 : 投擲"','"\\u00a7r\\u00A7f効果範囲 : 半径4m"']},Damage:248,HideFlags:1}}]}] SelectItem1 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:21b,id:"minecraft:conduit",tag:{display:{Name:'"\\u00a7r\\u00a7bコンカッション地雷"',Lore:['"\\u00a7r\\u00a79発光 (0:10)"','"\\u00a7r\\u00a7c吐き気 Ⅱ (0:10)"','"\\u00a7r\\u00A7f設置方法 : Shift+Qキー同時押し"','"\\u00a7r\\u00A7f設置以後 : アイテム非消失・設置者回収可能"','"\\u00a7r\\u00A7f効果範囲 : 半径1.5m"']},Tags:"Mine"}}]}] SelectItem2 0
