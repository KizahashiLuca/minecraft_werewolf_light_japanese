...
execute if score Time Version matches 15.. run function mwj:system/setting/decision_item_addition3/detect_dropped_honey_block
execute if score Time Version matches 16.. run function mwj:system/setting/decision_item_addition3/detect_dropped_soul_lantern