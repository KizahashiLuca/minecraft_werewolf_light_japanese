...
replaceitem entity @p[tag=Host] inventory.13 minecraft:potion{display:{Name:"\"\\u00A7r\\u00A7f透明化のポーション\""},CustomPotionEffects:[{Id:14,Duration:600}],CustomPotionColor:16777215} 1
replaceitem entity @p[tag=Host] inventory.14 minecraft:potion{display:{Name:"\"\\u00A7r\\u00A7f俊敏のポーション\""},CustomPotionEffects:[{Id:1,Amplifier:2,Duration:600}],CustomPotionColor:63217} 1
