...
execute if score Time PrevAddedRole matches 1.. run tellraw @a ["",{"text":"  追加役職(","color":"white"},{"score":{"name":"Time","objective":"PrevAddedRole"},"color":"white"},{"text":"組)とゲームモード・制限時間の設定をしてください。","color":"white"}]
execute if score Time PrevAddedRole matches 0 run tellraw @a ["",{"text":"  ゲームモード・制限時間の設定をしてください。","color":"white"}]
tellraw @a ["",{"text":"----------------------------------\n","color":"white"}]
