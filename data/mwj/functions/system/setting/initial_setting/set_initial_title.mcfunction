...
execute if score Time AddedRole matches 1.. run tellraw @a ["",{"text":"  追加役職(","color":"white"},{"score":{"name":"Time","objective":"AddedRole"},"color":"white"},{"text":"組)と制限時間の設定をしてください。","color":"white"}]
