...
execute if score #MWL AddedClWolf matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"賢狼","color":"red","bold":true},{"text":" : ","color":"white"},{"score":{"name":"#MWL","objective":"AddedClWolf"},"color":"white"},{"text":"人","color":"white"}]
