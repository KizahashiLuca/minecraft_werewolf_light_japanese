...
## Function Each Mode
execute as @p[tag=Host,scores={SelectItem1=1}] run function mwj:system/setting/decision_role_addition2/selected_fox
execute as @p[tag=Host,scores={SelectItem2=1}] run function mwj:system/setting/decision_role_addition2/selected_mason
execute as @p[tag=Host,scores={SelectItem3=1}] run function mwj:system/setting/decision_role_addition2/selected_detective
execute as @p[tag=Host,scores={SelectItem4=1}] run function mwj:system/setting/decision_role_addition2/selected_thief
execute as @p[tag=Host,scores={SelectItem5=1}] run function mwj:system/setting/decision_role_addition2/selected_cat