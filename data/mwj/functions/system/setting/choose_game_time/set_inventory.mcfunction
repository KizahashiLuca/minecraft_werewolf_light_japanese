...
loot replace entity @p[tag=Host] inventory.4 loot mwj:setting/choose_mode/choose_game_time
...
loot replace entity @p[tag=Host] inventory.15 loot mwj:setting/common/alphabet/m
...
loot replace entity @p[tag=Host,predicate=mwj:setting/choose_game_time/game_time_not_zero] inventory.25 loot mwj:setting/common/ok