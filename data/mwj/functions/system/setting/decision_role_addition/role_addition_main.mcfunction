...
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r怪盗の追加\""}}}}] ThrowItem 1
...
scoreboard players set @p[tag=host,nbt={Inventory:[{Slot:21b,id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r預言者の追加\""}}}]}] SelectedSeer 0
scoreboard players set @p[tag=host,nbt={Inventory:[{Slot:22b,id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r霊媒師の追加\""}}}]}] SelectedMedium 0
scoreboard players set @p[tag=host,nbt={Inventory:[{Slot:23b,id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r共有者の追加\""}}}]}] SelectedMason 0
scoreboard players set @p[tag=host,nbt={Inventory:[{Slot:24b,id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r探偵の追加\""}}}]}] SelectedDetec 0
scoreboard players set @p[tag=host,nbt={Inventory:[{Slot:25b,id:"minecraft:player_head",tag:{display:{Name:"\"\\u00A7r怪盗の追加\""}}}]}] SelectedThief 0
