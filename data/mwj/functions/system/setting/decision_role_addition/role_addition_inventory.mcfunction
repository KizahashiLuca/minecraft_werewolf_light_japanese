...
replaceitem entity @p[tag=host] inventory.12 minecraft:player_head{SkullOwner:"mhf_villager",display:{Name:"\"\\u00A7r村人の追加\""}} 1
replaceitem entity @p[tag=host] inventory.13 minecraft:player_head{SkullOwner:"mhf_witch",display:{Name:"\"\\u00A7r預言者の追加\""}} 1
replaceitem entity @p[tag=host] inventory.14 minecraft:player_head{SkullOwner:"mhf_witch",display:{Name:"\"\\u00A7r霊媒師の追加\""}} 1
replaceitem entity @p[tag=host] inventory.15 minecraft:player_head{SkullOwner:"mhf_golem",display:{Name:"\"\\u00A7r共有者の追加\""}} 1
replaceitem entity @p[tag=host] inventory.16 minecraft:player_head{SkullOwner:"mhf_witch",display:{Name:"\"\\u00A7r探偵の追加\""}} 1
...
execute if score Time AddedVilla matches 1.. run replaceitem entity @p[tag=host] inventory.3 minecraft:nether_star{display:{Name:"\"\\u00A7r選択済み\"",Taged:"Villa"}} 1
execute if score Time AddedSeer matches 1.. run replaceitem entity @p[tag=host] inventory.4 minecraft:nether_star{display:{Name:"\"\\u00A7r選択済み\"",Taged:"Seer"}} 1
execute if score Time AddedMedium matches 1.. run replaceitem entity @p[tag=host] inventory.5 minecraft:nether_star{display:{Name:"\"\\u00A7r選択済み\"",Taged:"Medium"}} 1
execute if score Time AddedMason matches 1.. run replaceitem entity @p[tag=host] inventory.6 minecraft:nether_star{display:{Name:"\"\\u00A7r選択済み\"",Taged:"Mason"}} 1
execute if score Time AddedDetec matches 1.. run replaceitem entity @p[tag=host] inventory.7 minecraft:nether_star{display:{Name:"\"\\u00A7r選択済み\"",Taged:"Detec"}} 1
