...
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:22b,id:"minecraft:purple_concrete",tag:{display:{Name:'"\\u00A7r\\u00A7f背徳者の追加"'}}}]}] SelectItem3 0
...
execute as @p[tag=Host,scores={SelectItem3=1}] run function mwj:system/setting/decision_role_addition3/selected_immoralist
