...
# scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:21b,id:"minecraft:white_concrete",tag:{display:{Name:'"\\u00A7r\\u00A7f追加役職の追加"'}}}]}] SelectItem2 0
...
# execute as @p[tag=Host,scores={SelectItem2=1}] run function mwj:system/setting/decision_role_addition3/selected_
