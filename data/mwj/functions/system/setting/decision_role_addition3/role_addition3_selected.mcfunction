...
execute as @p[tag=Host,scores={SelectItem2=1}] run function mwj:system/setting/decision_role_addition3/selected_sage
execute as @p[tag=Host,scores={SelectItem3=1}] run function mwj:system/setting/decision_role_addition3/selected_white_wolf
execute as @p[tag=Host,scores={SelectItem4=1}] run function mwj:system/setting/decision_role_addition3/selected_fanatic
execute as @p[tag=Host,scores={SelectItem5=1}] run function mwj:system/setting/decision_role_addition3/selected_immoralist