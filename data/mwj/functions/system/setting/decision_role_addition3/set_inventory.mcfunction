...
# replaceitem entity @p[tag=Host] inventory.12 minecraft:white_concrete{display:{Name:'"\\u00A7r\\u00A7f追加役職の追加"'}} 1
# replaceitem entity @p[tag=Host] inventory.13 minecraft:white_concrete{display:{Name:'"\\u00A7r\\u00A7f追加役職の追加"'}} 1
