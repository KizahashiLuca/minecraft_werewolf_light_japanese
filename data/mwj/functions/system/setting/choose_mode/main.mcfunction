...
execute if score #MWL Phase matches 80 as @p[tag=Host,predicate=mwj:setting/choose_mode/choose_hide_time] run function mwj:system/setting/hide_time_decision/change_to
