...
execute if score Time HideTime matches 1 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:10b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 2 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:11b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 4 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:12b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 6 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:13b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 8 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:14b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 12 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:15b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
execute if score Time HideTime matches 20 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:16b,id:"minecraft:nether_star",tag:{display:{Name:"\"\\u00A7r\\u00A7a選択済み\""}}}]}] SelectDecide 0
