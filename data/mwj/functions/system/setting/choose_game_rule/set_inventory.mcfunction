...
scoreboard players operation @p[tag=Host] CastMode = #MWL CastMode
loot replace entity @p[tag=Host] inventory.3 loot mwj:setting/choose_game_rule/game_mode_selected
loot replace entity @p[tag=Host] inventory.4 loot mwj:setting/choose_game_rule/dummyrole_mode_selected
loot replace entity @p[tag=Host] inventory.5 loot mwj:setting/choose_game_rule/cast_mode_selected
...
loot replace entity @p[tag=Host] inventory.14 loot mwj:setting/choose_game_rule/cast_mode
