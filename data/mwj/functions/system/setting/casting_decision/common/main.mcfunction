...
## Kill a dropped item
execute as @e[type=minecraft:item,scores={ThrowItem=1}] run function mwj:system/setting/casting_decision/common/detect_drop
...
execute if score #MWL Phase matches 95 run function mwj:system/setting/casting_decision/page_1/main
execute if score #MWL Phase matches 96 run function mwj:system/setting/casting_decision/page_2/main
execute if score #MWL Phase matches 97 run function mwj:system/setting/casting_decision/page_3/main
execute if score #MWL Phase matches 98 run function mwj:system/setting/casting_decision/page_4/main

## Function Each Mode
execute as @p[tag=Host,scores={SelectPrevPage=1}] run function mwj:system/setting/casting_decision/common/selected_prevpage
execute as @p[tag=Host,scores={SelectNextPage=1}] run function mwj:system/setting/casting_decision/common/selected_nextpage
execute as @p[tag=Host,scores={SelectCancel=1}] run function mwj:system/setting/casting_decision/common/selected_cancel
execute as @p[tag=Host,scores={SelectAllDel=1}] run function mwj:system/setting/casting_decision/common/selected_all_delete
execute as @p[tag=Host,scores={SelectNumber=1}] run function mwj:system/setting/casting_decision/common/set_inventory
execute as @p[tag=Host,scores={SelectOkay=1}] run function mwj:system/setting/casting_decision/common/selected_ok
execute as @p[tag=Host,scores={SelectDecide1=1}] run function mwj:system/setting/casting_decision/common/set_inventory
execute as @p[tag=Host,scores={SelectDecide2=1}] run function mwj:system/setting/casting_decision/common/set_inventory
execute as @p[tag=Host,scores={SelectDecide3=1}] run function mwj:system/setting/casting_decision/common/set_inventory
execute as @p[tag=Host,scores={SelectDecide4=1}] run function mwj:system/setting/casting_decision/common/set_inventory
execute as @p[tag=Host,scores={SelectDecide5=1}] run function mwj:system/setting/casting_decision/common/set_inventory