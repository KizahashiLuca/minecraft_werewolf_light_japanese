...
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:20b,id:"minecraft:blue_stained_glass",tag:{Tags:["MWLsetting","AddedThief"]}}]}] SelectItem1 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:21b,id:"minecraft:orange_concrete",tag:{Tags:["MWLsetting","AddedLtRed"]}}]}] SelectItem2 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:22b,id:"minecraft:orange_stained_glass",tag:{Tags:["MWLsetting","AddedCat"]}}]}] SelectItem3 0
