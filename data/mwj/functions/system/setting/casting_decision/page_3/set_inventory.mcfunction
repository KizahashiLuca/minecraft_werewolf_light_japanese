...
## Set scoreboard
scoreboard players operation #MWL NumOfSeers = #MWL AddedRole1
scoreboard players operation #MWL NumOfFkSeers = #MWL AddedRole2
scoreboard players operation #MWL NumOfSages = #MWL AddedRole3
scoreboard players operation #MWL NumOfMediums = #MWL AddedRole4
scoreboard players operation #MWL NumOfDetectives = #MWL AddedRole5