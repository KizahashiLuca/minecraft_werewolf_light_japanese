...
loot replace entity @p[tag=Host] inventory.14 loot mwj:item/special/honey_block
loot replace entity @p[tag=Host] inventory.15 loot mwj:item/special/lantern
