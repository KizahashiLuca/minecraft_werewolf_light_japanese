...
execute if score #MWL Version matches 15.. run function mwj:system/setting/item_addition_decision/page_3/detect_haven_honey_block
execute if score #MWL Version matches ..15 run scoreboard players set @p[tag=Host,nbt=!{Inventory:[{Slot:24b}]}] SelectItem5 0
execute if score #MWL Version matches 16.. run function mwj:system/setting/item_addition_decision/page_3/detect_haven_soul_lantern
