...
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:lime_stained_glass",tag:{display:{Name:'"\\u00A7r\\u00A7f村人の追加"'}}}}] ThrowItem 1
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:light_blue_stained_glass",tag:{display:{Name:'"\\u00A7r\\u00A7f予言者の追加"'}}}}] ThrowItem 1
