...
execute as @s[scores={DropTorch=1,RoleDone=0}] run function mwj:system/game_phase/detective/detect_torch_dropped
execute as @s[scores={DropTorch=1,RoleDone=1}] run function mwj:system/game_phase/roles/message_error

## Detect Page Role
execute as @s[scores={TurnPageRight=1,RoleDone=0}] run function mwj:system/game_phase/detective/message_to_detective
execute as @s[scores={TurnPageLeft=1,RoleDone=0}] run function mwj:system/game_phase/detective/message_to_detective
...
execute as @a[team=Player] if score @s NumOfPlayers = @p[scores={CurrentRole=31,RoleOfNum=1,RoleDone=0}] TargetOfRole run function mwj:system/game_phase/detective/result
