...
## Detect Respawn
execute if score @s[scores={TagOfRoleWork=1}] FoxSpawnSecond = #MWL Second if score @s[scores={TagOfRoleWork=1}] FoxSpawnTick = #MWL Tick run function mwj:system/game_phase/fox/detect_respawn
