...
execute as @a[predicate=mwj:player/player] if score @s NumOfPlayers = @p[scores={CurrentRole=25,TagOfRoleWork=1,RoleDone=0}] TargetOfRole run function mwj:system/game_phase/seer/result
