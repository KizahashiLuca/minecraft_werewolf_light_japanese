...
data modify storage mwj:teleporter Teleporter.Temp.Message set from entity @e[predicate=mwj:game_phase/lantern/detect_unset_soul_lantern,sort=nearest,limit=1] Item.tag.display.Lore[3]
data remove entity @e[predicate=mwj:game_phase/lantern/detect_unset_soul_lantern,sort=nearest,limit=1] Item.tag.Tags[1]
