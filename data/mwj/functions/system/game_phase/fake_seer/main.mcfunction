...
execute as @s[scores={DropTorch=1,RoleDone=0}] run function mwj:system/game_phase/fake_seer/detect_torch_dropped
execute as @s[scores={DropTorch=1,RoleDone=1}] run function mwj:system/game_phase/roles/message_error

## Detect Page Role
execute as @s[scores={TurnPageRight=1,RoleDone=0}] run function mwj:system/game_phase/fake_seer/message_to_fake_seer
execute as @s[scores={TurnPageLeft=1,RoleDone=0}] run function mwj:system/game_phase/fake_seer/message_to_fake_seer
...
execute as @a[predicate=mwj:player/player] if score @s NumOfPlayers = @p[scores={CurrentRole=26,TagOfRoleWork=1,RoleDone=0}] TargetOfRole run function mwj:system/game_phase/fake_seer/result
