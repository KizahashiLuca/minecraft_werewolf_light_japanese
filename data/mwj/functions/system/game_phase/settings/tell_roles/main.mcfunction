...
tellraw @a[scores={CurrentRole=21}] ["",{"text":"    ","color":"white"},{"text":"パン屋","color":"green","bold":true}]
tellraw @a[scores={CurrentRole=22}] ["",{"text":"    ","color":"white"},{"text":"村人","color":"green","bold":true}]
...
execute as @a[scores={CurrentRole=24}] run function mwj:system/game_phase/settings/tell_roles/pairs/mason