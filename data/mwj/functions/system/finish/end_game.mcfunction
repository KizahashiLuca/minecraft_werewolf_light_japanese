...
execute if score Time ChangeGameTime matches 1000.. run tellraw @a ["",{"text":"    ","color":"white"},{"score":{"name":"Time","objective":"ChangeGameTime"},"color":"white"},{"text":".00 sec.  :  ゲーム開始","color":"white"}]
execute if score Time ChangeGameTime matches 100..999 run tellraw @a ["",{"text":"    0","color":"white"},{"score":{"name":"Time","objective":"ChangeGameTime"},"color":"white"},{"text":".00 sec.  :  ゲーム開始","color":"white"}]
