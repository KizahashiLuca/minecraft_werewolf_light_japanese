...
execute if score Time ChangeLimitTime matches 1000.. run tellraw @a ["",{"text":"    ","color":"white"},{"score":{"name":"Time","objective":"ChangeLimitTime"},"color":"white"},{"text":".00 sec.  :  ゲーム開始","color":"white"}]
execute if score Time ChangeLimitTime matches 100..999 run tellraw @a ["",{"text":"    0","color":"white"},{"score":{"name":"Time","objective":"ChangeLimitTime"},"color":"white"},{"text":".00 sec.  :  ゲーム開始","color":"white"}]
