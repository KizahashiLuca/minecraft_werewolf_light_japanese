...
execute if score #MWL NumOfBakeries matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"パ ン 屋","color":"green"},{"text":" ： ","color":"white"},{"selector":"@a[scores={PrevRole=21}]","color":"white"}]
execute if score #MWL NumOfLycants matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"狼 憑 き","color":"green"},{"text":" ： ","color":"white"},{"selector":"@a[scores={PrevRole=22}]","color":"white"}]
execute if score #MWL NumOfMasons matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"共 有 者","color":"dark_green"},{"text":" ： ","color":"white"},{"selector":"@a[scores={PrevRole=24}]","color":"white"}]
...
execute if score #MWL DummyRole matches 5 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"パ ン 屋","color":"green"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 6 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"狼 憑 き","color":"green"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 7 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"共 有 者","color":"dark_green"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 8 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"予 言 者","color":"aqua"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 9 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"偽予言者","color":"aqua"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 10 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"賢    者","color":"aqua"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 11 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"霊 媒 師","color":"yellow"},{"text":" ： 1人","color":"white"}]
execute if score #MWL DummyRole matches 12 run tellraw @a ["",{"text":"    ","color":"white"},{"text":"探    偵","color":"dark_aqua"},{"text":" ： 1人","color":"white"}]
