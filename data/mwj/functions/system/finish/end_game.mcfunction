...
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/wolf] ["",{"text":"    ","color":"white"},{"text":"人    狼","color":"red"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/wolf]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/clever_wolf] ["",{"text":"    ","color":"white"},{"text":"賢    狼","color":"dark_red"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/clever_wolf]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/white_wolf] ["",{"text":"    ","color":"white"},{"text":"白    狼","color":"red"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/white_wolf]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/madman] ["",{"text":"    ","color":"white"},{"text":"狂    人","color":"light_purple"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/madman]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/fanatic] ["",{"text":"    ","color":"white"},{"text":"狂 信 者","color":"light_purple"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/fanatic]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/fox] ["",{"text":"    ","color":"white"},{"text":"羽 衣 狐","color":"dark_purple"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/fox]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/immoralist] ["",{"text":"    ","color":"white"},{"text":"背 徳 者","color":"dark_purple"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/immoralist]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/villager] ["",{"text":"    ","color":"white"},{"text":"村    人","color":"green"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/villager]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/bakery] ["",{"text":"    ","color":"white"},{"text":"パ ン 屋","color":"green"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/bakery]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/lycanthrope] ["",{"text":"    ","color":"white"},{"text":"狼 憑 き","color":"green"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/lycanthrope]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/mason] ["",{"text":"    ","color":"white"},{"text":"共 有 者","color":"dark_green"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/mason]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/seer] ["",{"text":"    ","color":"white"},{"text":"予 言 者","color":"aqua"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/seer]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/fake_seer] ["",{"text":"    ","color":"white"},{"text":"偽予言者","color":"aqua"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/fake_seer]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/sage] ["",{"text":"    ","color":"white"},{"text":"賢    者","color":"aqua"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/sage]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/medium] ["",{"text":"    ","color":"white"},{"text":"霊 媒 師","color":"yellow"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/medium]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/detective] ["",{"text":"    ","color":"white"},{"text":"探    偵","color":"dark_aqua"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/detective]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/thief] ["",{"text":"    ","color":"white"},{"text":"怪    盗","color":"blue"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/thief]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/little_red] ["",{"text":"    ","color":"white"},{"text":"赤ずきん","color":"gold"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/little_red]","color":"white"}]
tellraw @a[predicate=mwj:setting_phase/choose_role/chosen_role/cat] ["",{"text":"    ","color":"white"},{"text":"猫    又","color":"gold"},{"text":" ： ","color":"white"},{"selector":"@a[predicate=mwj:game_phase/preview_role/cat]","color":"white"}]
