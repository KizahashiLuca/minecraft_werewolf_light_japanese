...
execute as @a if score Time TIME matches 0 if score Time Limit matches 4..10 run playsound minecraft:item.trident.return master @s
execute as @a if score Time TIME matches 0 if score Time Limit matches 1..3 run playsound minecraft:item.trident.throw master @s
execute as @a if score Time TIME matches 0 if score Time Limit matches 0 run playsound minecraft:item.trident.thunder master @s
