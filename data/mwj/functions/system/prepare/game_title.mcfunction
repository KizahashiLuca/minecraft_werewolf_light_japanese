...
execute if score Time FOX matches 1.. run tellraw @a ["",{"text":"    ","color":"reset"},{"text":"妖    狐","color":"dark_purple"},{"text":"： ","color":"reset"},{"score":{"name":"Time","objective":"FOX"},"color":"reset"},{"text":"人","color":"reset"}]
...
tellraw @a[scores={ROLE=3}] ["",{"text":"\n    あなたは ","color":"reset"},{"text":"妖狐","color":"dark_purple"},{"text":" です。","color":"reset"}]
