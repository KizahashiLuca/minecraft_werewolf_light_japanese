...
loot replace entity @p[tag=Host] inventory.15 loot mwj:setting_phase/common/alphabet/m
...
loot replace entity @p[tag=Host,predicate=mwj:setting_phase/choose_game_time/game_time_not_zero] inventory.25 loot mwj:setting_phase/common/ok