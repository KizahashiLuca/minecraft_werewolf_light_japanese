...
## Setting phase
## Choose role
scoreboard players set #MWL SelectNumOfRest 0
scoreboard players set #MWL SelectRolePos1 0
scoreboard players set #MWL SelectRolePos2 0
scoreboard players set #MWL SelectRolePos3 0
scoreboard players set #MWL SelectRolePos4 0
scoreboard players set #MWL SelectRolePos5 0
## Choose item
scoreboard players set #MWL SelectItemPos1 0
scoreboard players set #MWL SelectItemPos2 0
scoreboard players set #MWL SelectItemPos3 0
scoreboard players set #MWL SelectItemPos4 0
scoreboard players set #MWL SelectItemPos5 0
## Choose hide time
...
scoreboard players set #MWL SetGameTime 1200
## Choose game mode
...
scoreboard players set #MWL Num01000 1000
scoreboard players set #MWL Num00100 100
scoreboard players set #MWL Num00060 60
scoreboard players set #MWL Num00010 10
scoreboard players set #MWL Num00006 6
scoreboard players set #MWL Num00005 5
scoreboard players set #MWL Num00002 2
scoreboard players set #MWL Num00001 1
scoreboard players set #MWL Num00000 0
scoreboard players set #MWL Digit100 0
scoreboard players set #MWL Digit010 0
scoreboard players set #MWL Digit001 0
## Number of roles
scoreboard players set #MWL PlayerRole 0
...
scoreboard players set #MWL PNumOfWolves 0
scoreboard players set #MWL PNumOfClWolves 0
scoreboard players set #MWL PNumOfWhWolves 0
scoreboard players set #MWL PNumOfMadmans 0
scoreboard players set #MWL PNumOfFanatics 0
scoreboard players set #MWL PNumOfFoxes 0
scoreboard players set #MWL PNumOfImmorals 0
scoreboard players set #MWL PNumOfVillagers 0
scoreboard players set #MWL PNumOfBakeries 0
scoreboard players set #MWL PNumOfLycants 0
scoreboard players set #MWL PNumOfMasons 0
scoreboard players set #MWL PNumOfSeers 0
scoreboard players set #MWL PNumOfFkSeers 0
scoreboard players set #MWL PNumOfSages 0
scoreboard players set #MWL PNumOfMediums 0
scoreboard players set #MWL PNumOfDetectives 0
scoreboard players set #MWL PNumOfThieves 0
scoreboard players set #MWL PNumOfLtReds 0
scoreboard players set #MWL PNumOfCats 0
## Number of items
