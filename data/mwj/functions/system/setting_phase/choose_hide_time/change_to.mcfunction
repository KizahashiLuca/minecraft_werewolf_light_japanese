...
## Replace inventory
scoreboard players operation #MWL Digit100 = #MWL HideTime
scoreboard players operation #MWL Digit100 /= #MWL Num00100
scoreboard players operation #MWL Digit010 = #MWL HideTime
scoreboard players operation #MWL Digit010 %= #MWL Num00100
scoreboard players operation #MWL Digit010 /= #MWL Num00010
scoreboard players operation #MWL Digit001 = #MWL HideTime
...
## Change phase
scoreboard players set #MWL Phase 71