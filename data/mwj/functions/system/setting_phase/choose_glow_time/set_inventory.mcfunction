...
loot replace entity @p[tag=Host] inventory.15 loot mwj:setting_phase/common/character/percent
...
loot replace entity @p[tag=Host] inventory.25 loot mwj:setting_phase/common/ok