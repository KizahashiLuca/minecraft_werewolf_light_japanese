...
## Pos2
execute if predicate mwj:phase/choose_item/page1 run scoreboard players add #MWL ChooseTotem 1
...
execute if predicate mwj:phase/choose_item/page2 run scoreboard players add #MWL ChooseSnowball 1
execute if predicate mwj:setting_phase/choose_item/range_error/snowball run scoreboard players set #MWL ChooseSnowball 0
execute if predicate mwj:phase/choose_item/page3 run scoreboard players add #MWL ChooseConduit 1
execute if predicate mwj:setting_phase/choose_item/range_error/conduit run scoreboard players set #MWL ChooseConduit 0
execute if predicate mwj:phase/choose_item/page4 run scoreboard players add #MWL ChooseSpyglass 1
