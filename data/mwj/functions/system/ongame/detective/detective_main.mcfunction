...
execute as @s[scores={DropTorch=1,RoleDone=0}] run function mwj:system/ongame/detective/detective_trigger
execute as @s[scores={DropTorch=1,RoleDone=1}] run function mwj:system/ongame/roles/message_error

## Detect Page Role
execute as @s[scores={TurnPageRight=1,RoleDone=0}] run function mwj:system/ongame/detective/detective_message
execute as @s[scores={TurnPageLeft=1,RoleDone=0}] run function mwj:system/ongame/detective/detective_message
...
execute as @a[team=Player] if score @s NUM = @p[scores={CurrentRole=31,RoleOfNum=1,RoleDone=0}] TargetOfRole run function mwj:system/ongame/detective/detective_result
