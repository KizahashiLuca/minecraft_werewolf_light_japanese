...
execute as @a[team=Player] if score @s NUM = @p[scores={CurrentRole=31,RoleOfNum=1,DONE=0}] RoleTarget run function mwj:system/ongame/detective/detective_result
