...
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 1"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 2"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 3"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 4"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 5"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 6"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 7"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 8"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 9"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NUM unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NUM = @s NUM run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 10"},"hoverEvent":{"action":"show_text","value":[{"selector":"@s"},{"text":" を探偵"}]},"color":"green","bold":true}]
