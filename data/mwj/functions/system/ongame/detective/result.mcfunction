...
execute if entity @p[scores={TEMP2=1,DeathCount=1..2,TEMP1=0..60}] as @a if score @s NUM = @p[scores={TEMP2=1}] NumberOfKiller run function mwj:system/ongame/detective/result_roles
