...
#### Victim : 2 -
#### Killer : 2 -
execute if score #MWL CountOfVictim matches 2.. if score #MWL CountOfKiller matches 2.. as @a[scores={FlagOfVictim=1},team=Player] run function mwj:system/ongame/kill_log/kill_log_sub
