...
execute if score #MWL PrevAddedRole matches 1.. if score #MWL NumOfLycants matches 1.. run function mwj:system/ongame/settings/decrease_number_of_role/roles/lycanthrope
