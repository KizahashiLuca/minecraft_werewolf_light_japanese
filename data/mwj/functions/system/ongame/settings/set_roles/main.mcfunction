...
execute if score #MWL DummyRole matches 1 run scoreboard players remove #MWL PlayerRole 1
function mwj:system/ongame/settings/set_roles/roles/madman

## Decide fanatics
scoreboard players operation #MWL PlayerRole = #MWL NumOfFanatics
execute if score #MWL DummyRole matches 2 run scoreboard players remove #MWL PlayerRole 1
...
execute if score #MWL DummyRole matches 3 run scoreboard players remove #MWL PlayerRole 1
...
execute if score #MWL DummyRole matches 4 run scoreboard players remove #MWL PlayerRole 1
...
execute if score #MWL DummyRole matches 5 run scoreboard players remove #MWL PlayerRole 1
function mwj:system/ongame/settings/set_roles/roles/bakery

## Decide bakeries
scoreboard players operation #MWL PlayerRole = #MWL NumOfLycants
execute if score #MWL DummyRole matches 6 run scoreboard players remove #MWL PlayerRole 1
...
execute if score #MWL DummyRole matches 12 run scoreboard players remove #MWL PlayerRole 1
...
execute if score #MWL DummyRole matches 13 run scoreboard players remove #MWL PlayerRole 1
function mwj:system/ongame/settings/set_roles/roles/thief

## Decide little reds
scoreboard players operation #MWL PlayerRole = #MWL NumOfLtReds
execute if score #MWL DummyRole matches 14 run scoreboard players remove #MWL PlayerRole 1
