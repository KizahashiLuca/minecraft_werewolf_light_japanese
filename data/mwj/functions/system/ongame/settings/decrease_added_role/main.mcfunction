...
execute if score #MWL PrevAddedRole matches 1.. if score #MWL AddedLycant matches 1.. run function mwj:system/ongame/settings/decrease_added_role/roles/lycanthrope
