...
execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["HoneyBlock","JustBorn"],NoGravity:1b,Particle:"minecraft:block minecraft:beacon",Radius:0.5f,Duration:100000000}
