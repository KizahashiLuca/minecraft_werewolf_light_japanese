...
execute as @s[scores={TORCH=1,DONE=0}] run function mwj:system/ongame/medium/medium_trigger
execute as @s[scores={TORCH=1,DONE=1}] run function mwj:system/ongame/message_error

## Detect Page Role
execute as @s[scores={ROLE_R_PAGE=1,DONE=0}] run function mwj:system/ongame/medium/medium_message
execute as @s[scores={ROLE_L_PAGE=1,DONE=0}] run function mwj:system/ongame/medium/medium_message
...
execute as @s[scores={ROLE_BUTTON=1..10,DONE=0}] run function mwj:system/ongame/medium/medium_calculation
execute as @s[scores={ROLE_BUTTON=1..10,DONE=1}] run function mwj:system/ongame/message_error

## Send a Result Message to Medium
execute as @a[team=Player] if score @s NUM = @p[scores={ROLE=6,ROLE_OF_NUM=1,DONE=0}] ROLE_TARGET run function mwj:system/ongame/medium/medium_result
