...
## Cat System
execute if score Time CAT matches 1.. as @a[scores={ROLE=10}] run function mwj:system/ongame/cat/cat_system

## Seer System
execute if score Time SEER matches 1.. as @a[scores={ROLE=5}] run function mwj:system/ongame/seer/seer_system

## Medium System
execute if score Time MEDIUM matches 1.. as @a[scores={ROLE=6}] run function mwj:system/ongame/medium/medium_system

## Detective System
execute if score Time DETECTIVE matches 1.. as @a[scores={ROLE=8}] run function mwj:system/ongame/detective/detective_system
