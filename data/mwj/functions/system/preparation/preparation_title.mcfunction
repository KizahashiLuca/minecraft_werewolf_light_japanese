...
tellraw @a ["",{"text":"\n----------------------------------","color":"reset"}]
tellraw @a ["",{"text":"Minecraft Werewolf Light","bold":true,"color":"red"},{"text":" ","color":"reset"},{"text":"Start!!","color":"green"}]
...
tellraw @a ["",{"text":"  人数の内訳は以下のとおりです。","color":"reset"}]
...
execute if score Time FOX matches 1.. run tellraw @a ["",{"text":"    ","color":"reset"},{"text":"羽 衣 狐","color":"dark_purple"},{"text":"： ","color":"reset"},{"score":{"name":"Time","objective":"FOX"},"color":"reset"},{"text":"人","color":"reset"}]
...
tellraw @a[scores={ROLE=3}] ["",{"text":"\n    あなたは ","color":"reset"},{"text":"羽衣狐","color":"dark_purple"},{"text":" です。","color":"reset"}]
