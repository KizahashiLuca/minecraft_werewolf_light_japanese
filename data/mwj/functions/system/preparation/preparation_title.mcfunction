...
execute if score Time MASON matches 1.. run tellraw @a ["",{"text":"    ","color":"white"},{"text":"共 有 者","color":"dark_green"},{"text":"： ","color":"white"},{"score":{"name":"Time","objective":"MASON"},"color":"white"},{"text":"人","color":"white"}]
