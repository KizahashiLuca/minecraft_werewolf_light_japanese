...
## Output the title
tellraw @a ["",{"text":"\n----------------------------------","color":"reset"}]
tellraw @a ["",{"text":"Minecraft Werewolf Light beta-1.3","bold":true,"color":"red"}]
tellraw @a ["",{"text":"  Thank you for Downloading","color":"reset"}]
tellraw @a ["",{"text":"  当ゲームの必要人数は","color":"reset"},{"text":" 3 ","bold":true,"color":"red"},{"text":"人から","color":"reset"},{"text":" 14 ","bold":true,"color":"red"},{"text":"人です。","color":"reset"}]
